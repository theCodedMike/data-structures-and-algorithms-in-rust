use data_structures_and_algorithms_in_rust::_4_basic_data_structures::exercise::{
    DoubleListHeadNonNullStack, DoubleListTailNonNullStack, ExerciseStack, Peek,
};

#[test]
fn double_list_head_non_null_stack_test() {
    let mut s = DoubleListHeadNonNullStack::new();
...
#[test]
fn double_list_tail_non_null_stack_test() {
    let mut s = DoubleListTailNonNullStack::new();
    s.push(1); // Head -> 1 <- Tail
