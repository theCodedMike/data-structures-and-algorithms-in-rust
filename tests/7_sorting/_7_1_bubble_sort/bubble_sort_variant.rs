...
///
/// cargo test -- --show-output cocktail_sort_test
///
#[test]
fn cocktail_sort_test() {
    ...
    println!("{:?}", nums);
    // [1, 2, 3, 3, 4, 5, 6, 6, 7, 8, 9, 10]
}

///
/// cargo test -- --show-output comb_sort_test
///
#[test]
fn comb_sort_test() {
...
///
/// cargo test -- --show-output cbic_sort1_test
///
#[test]
fn cbic_sort1_test() {
    ...
    cbic_sort1(&mut nums);
    println!("{:?}", nums);
    // [18, 21, 22, 31, 32, 43, 54, 56, 75, 99]
}

///
/// cargo test -- --show-output cbic_sort2_test
///
#[test]
fn cbic_sort2_test() {
    let mut nums = [54, 32, 99, 18, 75, 31, 43, 56, 21, 22];
